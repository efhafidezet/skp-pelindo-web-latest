        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-header text-uppercase">PENGGUNA</li>
                            <li class="nav-item">
                            ...
                            <li class="nav-header text-uppercase">KUESIONER</li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{url('')}}/questionnaires/list" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Kuesioner</p>
                                </a>
                            </li>
                            <li class="nav-header text-uppercase">Hasil</li>
                            <li class="nav-item">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            {{-- <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Survei Kepuasan Pelanggan</h1>
                            </div> --}}
                            <!-- /.col -->
                            {{-- <div class="col-sm-6">
